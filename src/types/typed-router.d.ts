...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'selfFile': RouteRecordInfo<'selfFile', '/selfFile', Record<never, never>, Record<never, never>>,
    'serveFile': RouteRecordInfo<'serveFile', '/serveFile', Record<never, never>, Record<never, never>>,
